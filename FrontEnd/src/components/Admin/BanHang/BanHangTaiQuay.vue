  ...
  <div id="sales-invoice" hidden>
    <table style="width: 100%; font-size: 0.8rem">
      <tr style="border: 1px solid white">
        ...
        <td><strong style="text-align: right; margin: 0; font-size: 0.9rem;">Cửa hàng Mũ bảo hiểm LTA hemlet</strong></td>
      </tr>
      <tr style="border: 1px solid white">
    ...
    <i style="text-align: center; margin-top: 2rem;">Cảm ơn quý khách đã mua hàng tại LTA hemlet, hẹn gặp lại quý khách!</i>
  </div>
  <div class="card">
    <div class="row">
