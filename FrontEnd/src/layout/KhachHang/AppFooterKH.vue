...
<template>
    ...
    <footer class="text-lg-start text-white" style="background-color: #3e4551">
            ...
            <section class="">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
                        ...
                        <hr class="mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff; height: 2px" />
                        <p><i class="pi pi-home mr-3"></i> Số 2, hẻm 19, ngách 41, ngõ 195 Trần Cung, Cổ Nhuế 1, Bắc Từ Liêm, Hà Nội</p>
                        <p><i class="pi pi-envelope mr-3"></i> letuananh2k1.works@gmail.com</p>
                        <p><i class="pi pi-phone mr-3"></i> 0981415200</p>
                        <p><i class="pi pi-print mr-3"></i> 0397849786</p>
                    </div>
                    <!--Grid column-->
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2023 Copyright by Lê Tuấn Anh
            <a class="text-white" href="https://mdbootstrap.com/">DATN</a>
        </div>
        <!-- Copyright -->
    </footer>
    <!-- Footer -->
